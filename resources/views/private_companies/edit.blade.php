@extends('layouts.app')
<!-- this code imports and extends layouts to create a form for editing previously created private companies, their old values are displayed in the fields and can be edited, there are routing buttons and linkage
to the CRUD functionality, it specifies no role of the user to avoid incorrect redirection -->
@section('content')
