@extends('layouts.app')
<!-- this code imports and extends layouts to create a form for editing previously created routes, their old values are displayed in the fields and can be edited, there are routing buttons and linkage
